    ...
    for (i = 0; i < argc; i++) {
        ...
        while (fline(&line, &size, fp) != -1) {
            ...
            *++end = '\0';
            ...
            fprintf(out, "INCBIN_CONST INCBIN_ALIGN unsigned char %s%sData[] = {\n    ", prefix, name);
            *--end = '\0';
            file++;
            ...
            fprintf(out, "\n};\n");
            fprintf(out, "INCBIN_CONST INCBIN_ALIGN unsigned char *%s%sEnd = g%sData + sizeof(g%sData);\n", prefix, name, name, name);
            fprintf(out, "INCBIN_CONST unsigned int %s%sSize = sizeof(g%sData);\n", prefix, name, name);
        }
end:
        free(line);
        fclose(fp);
